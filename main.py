...
def load_key_data(cpm):
    ...
    console.print(f"[bold green]Access Key [/bold green]: { data.get('access_key')   else 'OwnerCPMOne') }.")
    console.print(f"[bold green]Telegram ID[/bold green]: { data.get('telegram_id')  else 'CPMOne') }.")
